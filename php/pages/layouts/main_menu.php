      ...
      <div class="main-menu-header">
          <div class="media">
              ...
              <div class="media-body">
                  <h6 class="media-heading"><?php   echo $_SESSION["user"]["nombre"].' '.$_SESSION["user"]["apellidos"]; ?></h6>
                  <p class="notification-text font-small-3 text-muted"><?php   echo $_SESSION["user"]["correo"]; ?></p>
              </div>
          </div>
      </div>
        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class=" nav-item"><a href="#"><i class="icon-dropbox"></i><span class="menu-title">Productos</span></a>
            <ul class="menu-content">
              ...
              <li><a href="categorias.php" class="menu-item">Categorias</a></li>
              <li><a href="subcategorias.php" class="menu-item">Sub categorias</a></li>
